document.addEventListener("DOMContentLoaded", function() {
    ...
    playStopButton.addEventListener("click", function() {
        if (video.paused || video.ended) {
            ...
            playStopButton.style.backgroundImage = "url(/pause.png)";
        } else {
            video.pause();
            playStopButton.textContent = "Play";
            playStopButton.classList.remove("active");
            playStopButton.style.backgroundImage = "url(/play.png)";
        }
    });
    ...
    soundOnOffButton.addEventListener("click", function() {
        if (video.muted) {
            ...
            soundOnOffButton.style.backgroundImage = "url(/soundOn.png)";
        } else {
            video.muted = true;
            soundOnOffButton.textContent = "Sound On";
            soundOnOffButton.classList.add("active");
            soundOnOffButton.style.backgroundImage = "url(/soundOff.png)";
        }
    });
